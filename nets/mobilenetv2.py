...
class MobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1.):
        ...
        for t, c, n, s in interverted_residual_setting:#不断调用inverted resblock
        ...
        self.features.append(conv_1x1_bn(input_channel, self.last_channel))#最后再调整通道数，但是在deeplabv+中被删除掉
        self.features = nn.Sequential(*self.features)#构建成pytorch所需的格式
